...
export class ShareEffects extends BaseLoopbackEffects {
  ...
  public getUser$ = this.actions$
    .ofType(ShareActionTypes.GET_USER)
    .mergeMap((action: LoopbackAction) =>
      this.share.getUser(action.payload.id, action.payload.refresh)
  ...
  public getPost$ = this.actions$
    .ofType(ShareActionTypes.GET_POST)
    .mergeMap((action: LoopbackAction) =>
      this.share.getPost(action.payload.id, action.payload.refresh)
        .mergeMap((response: any) => concat(
