...
export class VoteEffects extends BaseLoopbackEffects {
  ...
  public getUser$ = this.actions$
    .ofType(VoteActionTypes.GET_USER)
    .mergeMap((action: LoopbackAction) =>
      this.vote.getUser(action.payload.id, action.payload.refresh)
  ...
  public getPost$ = this.actions$
    .ofType(VoteActionTypes.GET_POST)
    .mergeMap((action: LoopbackAction) =>
      this.vote.getPost(action.payload.id, action.payload.refresh)
        .mergeMap((response: any) => concat(
