...
import { ApplicationActions } from 'shared/ngrx/actions';
 ...
 */
@Injectable()
export class OrganizationCanDeactivateGuard implements CanDeactivate<CanComponentDeactivate> {
  constructor(
  ...
  public canDeactivate(component: CanComponentDeactivate): Observable<boolean> | boolean {
    this.store.dispatch(this.applicationActions.selectOrganization(null));
    return true;
  }
}
