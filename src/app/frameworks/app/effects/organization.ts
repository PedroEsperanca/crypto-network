...
import { OrganizationInterface, UserApi, LoopBackAuth } from 'frameworks/api';
...
export class OrganizationEffects {
  ...
  @Effect() public loadCollectionOnInit$ = Observable.of(this.organizationActions.loadCollection());
  ...
  @Effect() public addOrganizationToCollection$ = this.actions$
  ...
  @Effect() public removeOrganizationFromCollection$ = this.actions$
