...
export class UserApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public linkApps(id: any, fk: any, data: any = {}): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * This method returns no data.
   */
  public unlinkApps(id: any, fk: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/apps/rel/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public existsApps(id: any, fk: any): Observable<any> {
  ...
  /**
   * Confirm a user phone number with verification token.
   *
   * @param string uid 
   *
   * @param string token 
   ...
   * This method returns no data.
   */
  public confirmPhone(uid: any, token: any, redirect: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/confirmPhone";
    let _routeParams: any = {};
  ...
  /**
   * Statistical information for 'node' registers.
   *
   ...
   * </em>
   */
  public createManyIdentities(id: any, data: Array<any> = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/identities";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyCredentials(id: any, data: Array<any> = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/credentials";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyApps(id: any, data: Array<any> = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/apps";
    let _routeParams: any = {
